...
import 'customize_visit_screen.dart';
...
class _AmenitiesListScreenState extends State<AmenitiesListScreen> {
  ...
  static const List<AmenityCardItem> amenityCards = [
    AmenityCardItem(
      title: 'Meeting Room Red',
      imagePath: 'assets/meeting-room-red.png',
      tags: ['Great for views', 'higher demand'],
    ),
    AmenityCardItem(
      title: 'Meeting Room Blue',
      imagePath: 'assets/meeting-room-blue.png',
      tags: ['Quiet', 'heated, indoor'],
    ),
    AmenityCardItem(
      title: 'Meeting Room Green',
      imagePath: 'assets/meeting-room-green.jpg',
      tags: ['Quiet', 'heated, indoor'],
    ),
  ];
