      ...
      child: ElevatedButton(
        onPressed: () {
          ...
          showBookingSummaryPopup(
            ...
            sessionType: widget.sessionType ?? 'Shared Session',
  ...
  Widget _buildShimmerContent() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 24),
        const ShimmerContainer(width: 120, height: 20),
        const SizedBox(height: 12),
        Row(
          children: [
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (_, __) => Padding(
              ...
              child: ShimmerContainer(width: 70, height: 100),
            ),
          ),
        ),
        const SizedBox(height: 24),
        ...
        Wrap(
          spacing: 12,
          runSpacing: 12,
          children: List.generate(6, (_) => ShimmerContainer(width: 100, height: 80)),
        ),
        const SizedBox(height: 24),
        ...
        ...List.generate(6, (_) => Padding(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 10),
              Expanded(child: ShimmerContainer(width: double.infinity, height: 16)),
            ],
          ),
        )),
        const SizedBox(height: 20),
