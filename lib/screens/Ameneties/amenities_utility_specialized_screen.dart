...
import '../Ameneties_Laundry_Service/pick_slot_screen.dart';

/// Amenities screen - Utility/Specialized tab (Laundry room, Drying room).
class AmenitiesUtilitySpecializedScreen extends StatelessWidget {
  const AmenitiesUtilitySpecializedScreen({super.key});

  static const List<_AmenityItem> _items = [
    _AmenityItem(
      title: 'Laundry Room',
      description: 'Convenient self-service washing facilities.',
      iconPath: 'assets/services/laundry.png',
      showCrown: false,
    ),
    _AmenityItem(
      title: 'Drying Room',
      description: 'Properly ventilated space for quick and easy drying.',
      iconPath: 'assets/services/drying.png',
      showCrown: false,
    ),
  ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () => Navigator.of(context).pop(3), // Return chip index 3 (Utility/Specialized)
        ),
        centerTitle: true,
        title: const Text(
          'Amenities',
...
class _ChipsRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const selectedIndex = 3; // Utility/Specialized
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            onTap: () {
              // Let Facilities decide which tab should be active next.
              if (index == 0) {
              ...
              // index == 3 (Utility/Specialized): already on this screen.
            },
            child: Container(
...
/// Fixed card height so both cards are same height.
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        ...
        if (titleLower.contains('laundry') || titleLower.contains('drying')) {
              ...
              ClipRRect(
                ...
                child: Image.asset(
                  ...
                  errorBuilder: (_, __, ___) => Container(
                    ...
                    child: const Icon(Icons.local_laundry_service_outlined, color: AppTheme.textSecondary),
                  ),
                ),
              ),
              if (item.showCrown) ...[
